...
- Simply clone/download the repository as it is, customize it as you like, and create a **NEW** Pages project on Cloudflare using "Direct Upload" to upload your files
	- Once you have connected a project with Github, I do not believe there is a way to change the deployment method to Direct Upload. Direct Upload is also not available for Workers projects.
