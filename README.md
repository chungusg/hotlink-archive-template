...
![sign up for github](https://hotlink-archive-template.pages.dev/rename1/github-login.gif)
...
![navigate to settings on cloudflare](https://hotlink-archive-template.pages.dev/rename1/pages-settings.gif)
1. Go to Settings
