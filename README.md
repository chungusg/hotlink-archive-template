...
- Simply clone/download the repository as it is, customize it as you like, and upload everything to Cloudflare in a **NEW** Pages project. (Once you have connected a project with Github, I do not believe there is a way to change the deployment method to "Direct Upload". Direct Upload is also not available for Workers projects.)
